...
// SptagPostingLuaEmbed.h is intentionally not included here anymore: the
// client no longer auto-uploads sptag_posting.lua on connect. The header
// is kept in the tree (regenerated by AnnService/scripts/embed_sptag_posting_lua.py)
// for ad-hoc operator scripts that still want to ship the Lua programmatically
                                   ...
                                   std::vector<Helper::AsyncReadRequest> * /*reqs*/)
{
    ...
    policy.base.total_timeout = timeout_ms;
    policy.base.socket_timeout = (timeout_ms > 100) ? timeout_ms - 50 : timeout_ms;
    ...
    const std::chrono::microseconds &timeout)
{
    ...
    batch_policy.base.socket_timeout = (timeout_ms > 100) ? timeout_ms - 50 : timeout_ms;
    batch_policy.base.max_retries = 0;
    batch_policy.concurrent = true;
